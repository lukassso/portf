          ...
          <div class="page-header page-header-small" filter-color="green">
            ...
            <div class="container">
              <div class="content-center">
                <div class="cc-profile-image"><a href="#"><img src="images/lukasface.png" alt="Image" /></a></div>
                <div class="h2 title">Lukasz Koladko</div>
                <p class="category text-white">Junior Web Developer, Graphic Designer</p><a class="btn btn-primary smooth-scroll mr-2"
                  href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a><a class="btn btn-primary"
                  href="images/CV-Lukasz-Koladko.pdf" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
              </div>
            </div>
            <div class="section">
              <div class="container">
                <div class="button-container"><a class="btn btn-default btn-round btn-lg btn-icon" href="https://www.linkedin.com/in/lukasz-koladko/"
                    rel="tooltip" title="Follow me on LinkedIn"><i class="fa fa-linkedin"></i></a></div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="col-lg-6 col-md-12">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-8">37</div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="text-uppercase">Email:</strong></div>
                    <div class="col-sm-8">lukasz.koladko@gmail.com</div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
                    <div class="col-sm-8">+48 881 718 466</div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
                    <div class="col-sm-8">Poland, Warsaw, Mokotow</div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="text-uppercase">Language:</strong></div>
                    <div class="col-sm-8">Polish, English</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
            <div class="card-body">
                ...
                <div class="col-md-6">
                  <div class="progress-container progress-primary"><span class="progress-badge">JavaScript</span>
                    <div class="progress">
                      <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10"
                        data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
                        style="width: 60%;"></div><span class="progress-value">50%</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="progress-container progress-primary"><span class="progress-badge">Photoshop / Illustrator</span>
                    <div class="progress">
                      <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10"
                        data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
              ...
              <div class="ml-auto mr-auto">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a
                        href="#web-development">
                        <figure class="cc-effect"><img src="images/project2.png" alt="Image" />
                          <figcaption>
                            <div class="h4"></div>
                            <p>Web Development</p>
                          </figcaption>
                  ...
                  <div class="col-md-6">
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a
                        href="#web-development">
                        <figure class="cc-effect"><img src="images/project3.png" alt="Image" />
                          <figcaption>
                            <div class="h4"></div>
                            <p>Web Development</p>
                          </figcaption>
          ...
          <div class="row">
             -->
                  <div class="col-md-6">
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a
                        href="#graphic-design">
                        <figure class="cc-effect"><img src="images/graphic1.png" alt="Image" />
                          <figcaption>
                            <div class="h4"></div>
                            <p>Graphic Design</p>
                          </figcaption>
                    ...
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a
                        href="#graphic-design">
                        <figure class="cc-effect"><img src="images/graphic2.png" alt="Image" />
                          <figcaption>
                            <div class="h4"></div>
                            <p>Graphic Design</p>
                          </figcaption>
                  ...
                  <div class="col-md-6">
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a
                        href="#graphic-design">
                        <figure class="cc-effect"><img src="images/graphic3.png" alt="Image" />
                          <figcaption>
                            <div class="h4"></div>
                            <p>Graphic Design</p>
                          </figcaption>
                    ...
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a
                        href="#graphic-design">
                        <figure class="cc-effect"><img src="images/graphic4.png" alt="Image" />
                          <figcaption>
                            <div class="h4"></div>
                            <p>Graphic Design</p>
                          </figcaption>
          ...
          <div class="container cc-experience">
              ...
              <div class="row">
                <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                  <div class="card-body cc-experience-header">
                    ...
                    <div class="h5">CRI Poland Sp. z o.o.</div>
                  </div>
                </div>
                <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                  <div class="card-body">
                    <div class="h5">Solution Owner / Master Data Specialist</div>
                    <p>
                      <ul>
                        <li>Wdrożenie ERP Comarch i Office 365 oraz dostosowanie ich do potrzeb organizacji</li>
                        <li>Wdrożenie serwera firmowego dla baz danych SQL (SQL Server 2012, SSMS)</li>
                        <li>Prace nad utworzeniem firmowej strony internetowej (MySQL, WordPress, Agile/Scrum)</li>
                        <li>Pełnomocnictwo w zakresie ochrony danych osobowych i przepływu informacji</li>
                      </ul>
                    </p>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                  <div class="card-body cc-experience-header">
                    ...
                    <div class="h5">CRI Sp. z o.o.</div>
                  </div>
                </div>
                <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                  <div class="card-body">
                    <div class="h5">Project Manager</div>
                    <p>
                      <ul>
                        <li>Prowadzenie projektów kontroli jakości w zespołach 50-150 osobowych (ISO, Lean, Kanban)</li>
                        <li>Odpowiedzialność za realizację celów: terminowość, budżet, efektywność</li>
                      </ul>
            ...
            <div class="card">
              <div class="row">
                <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                  <div class="card-body cc-experience-header">
                    <p>January 2009 - May 2017</p>
                    <div class="h5">Najlepszewakacje.pl - Travel Agency</div>
                  </div>
                </div>
                <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                  <div class="card-body">
                    <div class="h5">Co-Owner</div>
                    <p>
                      <ul>
                        <li>Team lead i deweloper w projekcie budowy serwisu wyszukiwarki i sklepu z ofertami
                          turystycznymi wielu tour operatorów, wraz z elementami automatyzacji marketingu (Drupal,
                          HTML,
                          SASS, Javascript, jQuery, Ajax, PHP, Web service, UX, Graphic design, SEM)</li>
                        <li>Administracja infrastrukturą IT oraz przepływem danych osobowych (hosting www, Cloud)</li>
                        <li>Projektowanie grafik i przeprowadzanie kampanii digital w social media (AdWords, Facebook
                          Ads,
                          Twitter, Google+, Get Response, Sales Manago)</li>
                      </ul>
                    </p>
                  </div>
                </div>
            ...
            <div class="card">
              <div class="row">
                <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                  <div class="card-body cc-experience-header">
                    <p>January 2003 - May 2007</p>
                    <div class="h5">WorkTech</div>
                  </div>
                </div>
                <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                  <div class="card-body">
                    <div class="h5">Operator i programista maszyn CNC</div>
                    <p>
                      <ul>
                        <li>Programowanie i obsługa maszyn numerycznych CNC z wykorzystaniem G-code</li>
                        <li>Tworzenie oraz aktualizacja dokumentacji produktowej – rysunków i specyfikacji</li>
                        <li>Prace projektowe w biurze konstruktorskim z wykorzystaniem CAD/CAM/CAE</li>
                        <li>Projektowanie opakowań produktów</li>
                      </ul>
                      ...
                      ?>
                          ...
                          <div class="col-md-6">
                            <div class="card-body">
                              ...
                              <p class="pb-2">05-500, Warsaw, Poland</p>
                              <p class="mb-0"><strong>Phone</strong></p>
                              <p class="pb-2">+48 881 718 466</p>
                              <p class="mb-0"><strong>Email</strong></p>
                              <p>lukasz.koladko@gmail.com</p>
                            </div>
                          </div>
                        </div>
                      </div>
